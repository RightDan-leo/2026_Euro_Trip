const TODOS = [
  ...
  { id: 't3', text: '预订 5/1 维也纳→阿姆斯特丹早班机（OS371或KL1838）' },
  { id: 't4', text: '预订 5/2 阿姆斯特丹→布达佩斯中午班机（KL1975）' },
  ...
  { id: 't10', text: '预订酒店：维也纳（4/30, 5/3, 5/4 共3晚）' },
  { id: 't11', text: '预订酒店：阿姆斯特丹（5/1 共1晚）' },
  { id: 't12', text: '预订酒店：布达佩斯（5/2 共1晚）' },
...
items:[
{time:'07:00',ev:'✈️ 维也纳 → 阿姆斯特丹',bar:'flight',rows:[['建议航班','奥地利航空 OS371 或 KLM KL1838'],['飞行','约 1 小时 50 分'],['到达','Schiphol 机场 ~08:55']]},
{time:'09:30',ev:'🚆 Schiphol → Amsterdam Centraal',loc:'机场火车 ~15min',bar:'transport'},
{time:'09:50',ev:'🧳 寄存行李于中央车站',bar:'transport',note:'Tips: 大柜90x60x40cm(可放28寸)，小柜90x40x40cm(登机箱)。强烈建议带登机箱！'},
...
{time:'10:20',ev:'🕯️ Skins Cosmetics 买蜡烛',loc:'Runstraat 11, Amsterdam',bar:'shopping',note:'目标：Carrière Frères (Tiare味道)。离 Le Labo 步行仅1分钟！'},
{time:'10:35',ev:'☕ 咖啡豆：Bocca Coffee Roasters',loc:'Kerkstraat 96, Amsterdam',bar:'shopping',note:'荷兰顶级精品咖啡！买一包代表阿姆现代风味的浅烘豆。'},
{time:'10:45',ev:'💿 淘碟：Concerto 唱片店',loc:'Utrechtsestraat 52-60',bar:'shopping',note:'全欧洲买到 Isaac Gracie 最大的希望！'},
{time:'11:15',ev:'🛍️ 战利品寄存建议',bar:'free',note:'Tips: 蜡烛等重物建议提去 Rijksmuseum 的免费衣帽间寄存，彻底解放双手逛展！'},
{time:'11:30-13:30',ev:'🎨 Rijksmuseum 国立博物馆',loc:'Museumstraat 1',bar:'museum',note:'重点：夜巡 + 倒牛奶的女仆 ✦ 可看《夜巡》修复工程'},
{time:'13:30',ev:'🚆 前往海牙 (火车上简餐)',bar:'transport',note:'在阿姆中央车站或南站乘坐火车前往 Den Haag Centraal (约50分钟)'},
{time:'14:30',ev:'抵达海牙',bar:'transport'},
{time:'14:45-16:00',ev:'🎨 Mauritshuis 莫瑞泰斯皇家美术馆 🧲',loc:'Plein 29, Den Haag',bar:'museum',note:'重点：戴珍珠耳环的少女 ✦ 必买：官方精美冰箱贴'},
{time:'16:15',ev:'🚆 海牙 → 阿姆斯特丹',bar:'transport',note:'⚠️ 预留充足时间赶回阿姆，切勿错过梵高入场时间！'},
{time:'17:45-19:30',ev:'🎨 Van Gogh Museum 梵高博物馆 (夜场)',loc:'Museumplein 6',bar:'museum',note:'重点：向日葵+杏花+麦田群鸦。⚠️ 必须在 17:45-18:15 之间排队入场！'},
{time:'19:45+',ev:'🍽️ 晚饭大餐 · 🏨 入住酒店 🧲',bar:'hotel',note:'晚间闲逛必买：正规店的 Delft Blue 蓝瓷小屋，或穿传统服饰的 Miffy 兔冰箱贴！'},
],
arts:[
...
items:[
{time:'07:00-08:00',ev:'🏃 备选晨跑：Vondelpark',loc:'Vondelpark, Amsterdam',bar:'free',note:'阿姆中央公园，一圈 3.3km，平坦绝美。跑完洗个澡去机场！'},
{time:'09:00',ev:'退房 · 前往 Schiphol 机场',bar:'transport'},
{time:'11:45',ev:'✈️ 阿姆斯特丹 → 布达佩斯',bar:'flight',rows:[['建议航班','荷兰皇家航空 KL1975 (更早班次)'],['飞行','约 2 小时'],['到达','BUD 机场 ~13:45']]},
{time:'15:30',ev:'🏨 入住布达佩斯酒店并稍作换装',bar:'hotel'},
{time:'16:30',ev:'☕ 世界最美：New York Café',loc:'New York Café, Budapest',bar:'food',note:'号称“世界上最美的咖啡馆”，宛如皇宫！在此享用华丽下午茶补充体力。强烈建议提前官网订座。'},
...
{time:'10:00-12:00',ev:'♨️ 塞切尼温泉 (早鸟入场)',loc:'Széchenyi Thermal Bath',bar:'sight',note:'离火车站极近！完美使用“11点前”的 Fast Track 门票，享受人少的清晨泡汤。'},
{time:'12:30',ev:'🍽️ 午餐',bar:'food'},
{time:'13:30-15:30',ev:'🏰 布达城堡 + 渔人堡 + 马加什教堂 🧲',loc:'Castle Hill',bar:'sight',note:'必买：官方亭的手工立体渔人堡冰箱贴，或找找硬核的匈牙利“微缩魔方”！'},
