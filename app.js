const TODOS = [
  ...
  { id: 't5', text: '已预订 Rijksmuseum 门票（5/1 13:30）✅' },
  { id: 't6', text: '🚨 抢救预购 Van Gogh Museum 门票（官网无票，速去Klook买套票或TicketSwap捡漏）' },
  { id: 't7', text: '已预订 Mauritshuis 门票（5/2 10:00）✅' },
  { id: 't8', text: '购买 Eric Clapton 演唱会门票（MVM Dome）' },
  { id: 't9', text: '预订 5/3 布达佩斯→维也纳火车票' },
  { id: 't10', text: '已预订维也纳酒店（4/30 Moxy, 5/3-5/4 Park Hyatt）✅' },
  { id: 't11', text: '已预订阿姆斯特丹酒店（5/1 The Hoxton）✅' },
  { id: 't12', text: '已预订布达佩斯酒店（5/2 InterContinental）✅' },
...
{time:'10:00',ev:'🏨 入住 Moxy Vienna Airport',loc:'Moxy Vienna Airport, Einfahrtsstraße 1-3, 1300 Schwechat',bar:'hotel',rows:[['位置','维也纳国际机场 (VIE)内'],['入住','15:00 后 (先寄存行李)']],note:'直接把大件行李扔在机场酒店，轻装上阵坐 CAT 去市中心！'},
...
{time:'12:15',ev:'🏨 抵达 The Hoxton, Amsterdam',loc:'The Hoxton Amsterdam, Herengracht 255, Amsterdam',bar:'hotel',rows:[['位置','Herengracht 255 (九条街区域)'],['入住','14:00 后 (先寄存行李)']],note:'位置绝佳！放下行李后，下楼几步就是 Le Labo！'},
{time:'12:45',ev:'🧴 Le Labo 购买限定香水',bar:'shopping',cls:'lelabo-card',rows:[['香水','Mousse de Chêne 30'],['地址','Reestraat 10, 1016 DN'],['备注','The Hoxton 走过去极近！']]},
{time:'13:10',ev:'前往博物馆广场',bar:'transport'},
{time:'13:30-16:30',ev:'🎨 Rijksmuseum 国立博物馆',loc:'Museumstraat 1',bar:'museum',note:'重点：夜巡 + 倒牛奶的女仆。⚠️ 门票已预约 13:30！'},
...
{time:'09:30-10:50',ev:'🎨 Mauritshuis 莫瑞泰斯皇家美术馆 🧲',loc:'Plein 29, Den Haag',bar:'museum',note:'⚠️ 门票已预约 10:00！先在周围喝个咖啡。重点：戴珍珠耳环的少女'},
...
{time:'17:30',ev:'🏨 入住 InterContinental Budapest (洲际)',loc:'InterContinental Budapest, Apáczai Csere János u. 12-14, Budapest',bar:'hotel',rows:[['位置','Apáczai Csere János u. 12-14 (链子桥旁)'],['入住','15:00 后 (抵达可直接办理)']],note:'⚠️ 交通优化：从机场直刷 100E 大巴至 Deák Ferenc tér，走几步即到。'},
...
{time:'20:30',ev:'🏨 入住 Park Hyatt Vienna (柏悦)',loc:'Park Hyatt Vienna, Am Hof 2, 1010 Wien',bar:'hotel',rows:[['位置','Am Hof 2 (内城区, 名品街旁)'],['入住','15:00 后 (抵达可直接办理)']],note:'维也纳最奢华的区域！今晚好好休息，享受顶级服务。'},
]},
