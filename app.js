...
{time:'10:00',ev:'🏨 入住 Moxy Vienna Airport',bar:'hotel',rows:[['位置','维也纳国际机场 (VIE)内'],['入住','15:00 后 (先寄存行李)']],note:'直接把大件行李扔在机场酒店，轻装上阵坐 CAT 去市中心！'},
...
{time:'12:15',ev:'🏨 抵达 The Hoxton, Amsterdam',bar:'hotel',rows:[['位置','Herengracht 255 (九条街区域)'],['入住','14:00 后 (先寄存行李)']],note:'位置绝佳！放下行李后，下楼几步就是 Le Labo！'},
...
{time:'17:30',ev:'🏨 入住 InterContinental Budapest (洲际)',bar:'hotel',rows:[['位置','Apáczai Csere János u. 12-14 (链子桥旁)'],['入住','15:00 后 (抵达可直接办理)']],note:'⚠️ 交通优化：从机场直刷 100E 大巴至 Deák Ferenc tér，走几步即到。'},
...
{time:'20:30',ev:'🏨 入住 Park Hyatt Vienna (柏悦)',bar:'hotel',rows:[['位置','Am Hof 2 (内城区, 名品街旁)'],['入住','15:00 后 (抵达可直接办理)']],note:'维也纳最奢华的区域！今晚好好休息，享受顶级服务。'},
]},
