...
{time:'10:00',ev:'🏨 入住机场酒店，放下行李',bar:'hotel',note:'酒店：Moxy Vienna Airport。直接把行李扔在机场，轻装上阵坐 CAT 去市中心！'},
...
{time:'12:15',ev:'🏨 抵达酒店，放下行李',bar:'hotel',note:'酒店：The Hoxton。位置极佳！'},
...
{time:'17:30',ev:'🏨 入住 InterContinental 洲际酒店',bar:'hotel',note:'⚠️ 交通优化：从机场出门直接刷卡坐 100E 大巴，40分钟直达 Deák Ferenc tér，走几步就到。'},
...
{time:'20:30',ev:'🏨 入住 Park Hyatt 柏悦酒店',bar:'hotel',note:'维也纳最奢华的区域！'},
]},
